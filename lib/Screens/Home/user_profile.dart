...
class _UserProfileState extends State<UserProfile> {
  ...
  final _phoneError = "Inserted phone number is not valid";
  final _teamsError = "Inserted MS Teams account is not valid";
  final _fbError = "Inserted Facebook URL is not valid";
  final _instaError = "Inserted Instagram URL is not valid";
  ...
  void content() {
    setState(() {
      ...
      if (istacontroller.text.length < 5 ||
          ...
          !istacontroller.text.contains('a')) {
        _instaInvalid = true;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Your personal profile'),
        actions: <Widget>[
          IconButton(
            icon: const Icon(
              Icons.folder_shared,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        padding: EdgeInsets.fromLTRB(55 * heightR, 260 * widthR,
                            55 * heightR, 260 * widthR),
                        child: const Text(
                            'Create or change your personal profile. We will generate your own QR code from your profile',
                      ...
                      Container(
                          ...
                          padding:
                              EdgeInsets.fromLTRB(120 * curR, 0, 120 * curR, 0),
